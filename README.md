...
## Installation
  ...
  ```bash
  sudo curl -L "https://github.com/danangkonang/gomigrator/releases/download/0.1.1/gomigrator" -o gomigrator && sudo chmod +x gomigrator
  ```

  - global install

  ```bash
  sudo curl -L "https://github.com/danangkonang/gomigrator/releases/download/0.1.1/gomigrator" -o /usr/local/bin/gomigrator
  ```
